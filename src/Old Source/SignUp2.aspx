<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="SignUp2.aspx.vb" Inherits="SignUp2" MaintainScrollPositionOnPostBack="true" %>
        ...
        <tr>
            <td style="width: 750px">
                ...
                Last Name <span style="color: #ff0000">*</span></td>
                    ...
                    <tr style="color: #000000">
                        <td class="form1Labels">
                Company Name <span style="color: red">*</span></td>
                        <td class="form1Entry">
...
&nbsp;or
                    ...
                    <tr style="color: #000000">
                        ...
                        <td class="form1Entry">
                            <asp:TextBox ID="tPeople" runat="server" Width="50px"></asp:TextBox></td>
                    </tr>
                    <tr>
