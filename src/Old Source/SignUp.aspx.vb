...
Partial Class Forms_SignUp1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.IsPostBack = False Then
            Page.Header.Title = "Sign Up for HVAC, Electrical Training Seminars | American Trainco"

            Dim mtD As New HtmlMeta()
            mtD.Name = "description"
            mtD.Content = "Sign up for Facility & Plant Management seminars if you're looking for additional training or certification testing. Register here for a 1 or 2-day course."
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        If (Not (Email.Text = "bobz@americantrainco.com")) And goodEntry() Then
            ...
            sendSignUpEmail()
        End If
        Response.Redirect("~/SignUp_ThankYou.aspx")
    ...
    Protected Function goodEntry() As Boolean
        ...
        ElseIf (checkString(Company.Text, 255) = checkString(theTitle.Text, 255)) Or (checkString(Company.Text, 255) = checkString(Address1.Text, 255)) Then
            rtn = False
        ElseIf (Len(checkString(Address2.Text, 255)) > 5) And (checkString(City.Text, 255) = "New York") Then
            rtn = False
    ...
    Protected Sub postSignUp()
        ...
        sB.Append("'ATI Website - In-House', ")
        ...
        xText = checkString(tDays.Text, 255)
        theText = theText + "# Days: " + xText + vbCr
        xText = checkString(tWhen.Text, 255)
        theText = theText + "When: " + xText + vbCr
        xText = checkString(tNotes.Text, 2000)
        theText = theText + "Special Notes: " + xText + vbCr
    ...
    Protected Sub sendSignUpEmail()
        ...
        Dim strTo As String = System.Configuration.ConfigurationManager.AppSettings("InHouseEmail")
        Dim strSubject As String = "In-House Training Info Request from Website"
        Dim strBody As String = ""
        Dim sB As New StringBuilder
        'strTo = "bobz@americantrainco.com"

        sB.Append("Date: " + Today().ToString + vbCrLf + vbCrLf)
        sB.Append("The following new In-House Web Signup record has just been posted:" + vbCrLf + vbCrLf)
        ...
        sB.Append("Number of Days: " + checkString(tDays.Text, 255) + vbCrLf)
        sB.Append("Timeframe: " + checkString(tWhen.Text, 255) + vbCrLf)
        sB.Append("Special Notes: " + vbCrLf)
        sB.Append(checkString(tNotes.Text, 2000) + vbCrLf + vbCrLf)
